...
def report(
    ...
    sep: str = typer.Option(",", help="Разделитель в CSV."),
    encoding: str = typer.Option("utf-8", help="Кодировка файла."),
    title: str = typer.Option("EDA-отчёт", help="Заголовок в файле report.md"),
    max_hist_columns: int = typer.Option(6, help="Максимум числовых колонок для гистограмм."),
    min_missing_share: float = typer.Option(0.5, help="Минимальная доля пропусков")
) -> None:
    """
    ...
    with md_path.open("w", encoding="utf-8") as f:
        ...
        f.write(f"- Уникальны ли user_id: **{quality_flags['has_suspicious_id_duplicates']}**\n")
        f.write(f"- Есть ли столбцы с одинаковыми значениями: **{quality_flags['has_constant_columns']}**\n\n")
    ...
    # 5. Картинки
    plot_histograms_per_column(df, out_root, max_columns=max_hist_columns, min_missing_share=min_missing_share)
